...
##   --quiet CMD INSTALL  \
##   '/tmp/RtmpeWIbat/devtools1370769e2fa6/npcooley-FindHomology-e9629cf'  \
...
```
## ===========================================================================
## Time difference of 1.011542 mins
```
...
```
## ===========================================================================
## Time difference of 1.850396 mins
```
...
```
## ===========================================================================
## Time difference of 32.4754 secs
```
