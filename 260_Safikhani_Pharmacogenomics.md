...
#> Warning in PharmacoGx::connectivityScore(x = x, y = HDAC, method =
#> "gsea", : Using fGSEA method to calculate GSEA
...
#>  [4] IRanges_2.15.14      S4Vectors_0.19.17    randomForest_4.6-14 
...
#> [19] ggplot2_3.0.0        Biobase_2.41.1       BiocGenerics_0.27.1 
...
#>  [10] DRR_0.0.3           SnowballC_0.5.1     bit64_0.9-7        
#>  [13] lubridate_1.7.4     prodlim_2018.04.18  codetools_0.2-15   
#>  [16] splines_3.5.1       robustbase_0.93-1   knitr_1.20         
#>  [19] RcppRoll_0.3.0      magicaxis_2.0.3     broom_0.5.0        
...
#>  [37] glue_1.3.0          RANN_2.6            dplyr_0.7.6        
#>  [40] maps_3.3.0          fastmatch_1.1-0     Rcpp_0.12.17       
#>  [43] slam_0.1-43         gdata_2.18.0        nlme_3.1-137       
#>  [46] iterators_1.0.10    timeDate_3043.102   gower_0.1.2        
#>  [49] xfun_0.3            stringr_1.3.1       gtools_3.8.1       
#>  [52] DEoptimR_1.0-8      MASS_7.3-50         scales_0.5.0       
#>  [55] ipred_0.9-6         relations_0.6-8     RColorBrewer_1.1-2 
#>  [58] sets_1.0-18         yaml_2.1.19         memoise_1.1.0      
#>  [61] gridExtra_2.3       downloader_0.4      rpart_4.1-13       
#>  [64] RSQLite_2.1.1       latticeExtra_0.6-28 stringi_1.2.4      
...
#>  [76] bitops_1.0-6        pracma_2.1.4        evaluate_0.11      
#>  [79] purrr_0.2.5         bindr_0.1.1         recipes_0.1.3      
#>  [82] htmlwidgets_1.2     bit_1.1-14          CVST_0.2-2         
#>  [85] tidyselect_0.2.4    plyr_1.8.4          magrittr_1.5       
#>  [88] bookdown_0.7.14     R6_2.2.2            gplots_3.0.1       
#>  [91] dimRed_0.1.0        DBI_1.0.0           sm_2.2-5.5         
#>  [94] pillar_1.3.0        foreign_0.8-70      withr_2.1.2        
#>  [97] abind_1.4-5         nnet_7.3-12         tibble_1.4.2       
#> [100] crayon_1.3.4        KernSmooth_2.23-15  rmarkdown_1.10     
#> [103] grid_3.5.1          data.table_1.11.4   marray_1.59.0      
#> [106] blob_1.1.1          piano_1.21.0        ModelMetrics_1.1.0 
#> [109] digest_0.6.15       tidyr_0.8.1         munsell_0.5.0      
#> [112] celestial_1.4.1     magic_1.5-8         tcltk_3.5.1
```
