...
<div class="figure">
<img src="/tmp/tmp.69wDZp7mL6/BiocWorkshops/230_Isserlin_RCy3_intro/images/Apps-4.png" alt="Available Cytoscape Apps" width="1554" />
...
<div class="figure">
<img src="/tmp/tmp.69wDZp7mL6/BiocWorkshops/230_Isserlin_RCy3_intro/images/tables2networks.png" alt="Translating data to networks" width="792" />
...
<div class="figure">
<img src="/tmp/tmp.69wDZp7mL6/BiocWorkshops/230_Isserlin_RCy3_intro/images/CytoscapeAutomation_3.png" alt="Different ways to communicate with Cytoscape" width="500" />
...
<img src="/tmp/tmp.69wDZp7mL6/BiocWorkshops/230_Isserlin_RCy3_intro/images/screenshot_cytoscapeping.png" width="918" />
...
<img src="/tmp/tmp.69wDZp7mL6/BiocWorkshops/230_Isserlin_RCy3_intro/images/screenshot_cytoscapeversion.png" width="920" />
...
<img src="/tmp/tmp.69wDZp7mL6/BiocWorkshops/230_Isserlin_RCy3_intro/images/screenshot_availablecommands.png" width="920" />
...
<img src="/tmp/tmp.69wDZp7mL6/BiocWorkshops/230_Isserlin_RCy3_intro/images/screenshot_networkload_1.png" width="921" />
...
<div class="figure">
<img src="/tmp/tmp.69wDZp7mL6/BiocWorkshops/230_Isserlin_RCy3_intro/images/initial_example_network.png" alt="Example network created from dataframe" width="444" />
...
<div class="figure">
<img src="/tmp/tmp.69wDZp7mL6/BiocWorkshops/230_Isserlin_RCy3_intro/images/interaction-dbs.png" alt="Info graphic of some of the available pathway databases" width="2776" />
...
<img src="/tmp/tmp.69wDZp7mL6/BiocWorkshops/230_Isserlin_RCy3_intro/images/screenshot_availablestringcommands.png" width="922" />
...
<img src="/tmp/tmp.69wDZp7mL6/BiocWorkshops/230_Isserlin_RCy3_intro/images/screenshot_availablestringarguments.png" width="921" />
...
<img src="/tmp/tmp.69wDZp7mL6/BiocWorkshops/230_Isserlin_RCy3_intro/images/screenshot_stringnetworkload.png" width="922" />
...
<div class="figure">
<img src="/tmp/tmp.69wDZp7mL6/BiocWorkshops/230_Isserlin_RCy3_intro/images/initial_string_network.png" alt="Initial network returned by String from our set of Mesenchymal query genes" width="444" />
...
<img src="/tmp/tmp.69wDZp7mL6/BiocWorkshops/230_Isserlin_RCy3_intro/images/screenshot_availablelayouts.png" width="924" />
...
<img src="/tmp/tmp.69wDZp7mL6/BiocWorkshops/230_Isserlin_RCy3_intro/images/screenshot_availablelayoutarguments.png" width="922" />
...
<div class="figure">
<img src="/tmp/tmp.69wDZp7mL6/BiocWorkshops/230_Isserlin_RCy3_intro/images/relayout_string_network.png" alt="Initial network returned by String from our set of Mesenchymal query genes" width="444" />
...
<img src="/tmp/tmp.69wDZp7mL6/BiocWorkshops/230_Isserlin_RCy3_intro/images/screenshot_availablenodecolumns.png" width="518" />
...
<img src="/tmp/tmp.69wDZp7mL6/BiocWorkshops/230_Isserlin_RCy3_intro/images/screenshot_nodetable.png" width="926" />
...
<img src="/tmp/tmp.69wDZp7mL6/BiocWorkshops/230_Isserlin_RCy3_intro/images/screenshot_nodeattributeload.png" width="928" />
...
<img src="/tmp/tmp.69wDZp7mL6/BiocWorkshops/230_Isserlin_RCy3_intro/images/screenshot_visualstyleapplied.png" width="927" />
...
<img src="/tmp/tmp.69wDZp7mL6/BiocWorkshops/230_Isserlin_RCy3_intro/images/screenshot_availablenodeshapes.png" width="920" />
...
<div class="figure">
<img src="/tmp/tmp.69wDZp7mL6/BiocWorkshops/230_Isserlin_RCy3_intro/images/mesen_string_network.png" alt="Formatted String network from our set of Mesenchymal query genes.  Annotated with our expressin data" width="444" />
...
<div class="figure">
<img src="/tmp/tmp.69wDZp7mL6/BiocWorkshops/230_Isserlin_RCy3_intro/images/correlation_network.png" alt="Example correlation network created using aMatReader" width="444" />
...
```r
 ...
 em_results_filename <-file.path(getwd(),
  ...
  head(em_results)
```
<img src="/tmp/tmp.69wDZp7mL6/BiocWorkshops/230_Isserlin_RCy3_intro/images/screenshot_gprofiler_emresults.png" width="514" />
...
<div class="figure">
<img src="/tmp/tmp.69wDZp7mL6/BiocWorkshops/230_Isserlin_RCy3_intro/images/cluster1em.png" alt="Example Enrichment Map created when running an enrichment analysis using g:Profiler with the genes that are part of cluster 1" width="444" />
...
<div class="figure">
<img src="/tmp/tmp.69wDZp7mL6/BiocWorkshops/230_Isserlin_RCy3_intro/images/cluster1em_annot.png" alt="Example Annotated Enrichment Map created when running an enrichment analysis using g:Profiler with the genes that are part of cluster 1" width="339" />
...
<div class="figure">
<img src="/tmp/tmp.69wDZp7mL6/BiocWorkshops/230_Isserlin_RCy3_intro/images/cluster1em_annot_man.png" alt="Example Annotated Enrichment Map created when running an enrichment analysis using g:Profiler with the genes that are part of cluster 1 after manual adjusting to generate a cleaner figure" width="329" />
...
<img src="/tmp/tmp.69wDZp7mL6/BiocWorkshops/230_Isserlin_RCy3_intro/images/screenshot_ora_results.png" width="518" />
...
<div class="figure">
<img src="/tmp/tmp.69wDZp7mL6/BiocWorkshops/230_Isserlin_RCy3_intro/images/mesenem.png" alt="Example Enrichment Map created when running an enrichment analysis using EnrichmentBrowser ORA with the genes differential in Mesenchymal OV" width="339" />
...
<div class="figure">
<img src="/tmp/tmp.69wDZp7mL6/BiocWorkshops/230_Isserlin_RCy3_intro/images/mesenem_summary_network.png" alt="Example Annotated Enrichment Map created when running an enrichment analysis using EnrichmentBrowser ORA with the genes that differential in mesenchymal OV" width="339" />
