...
ragged array schema for genomic location data. It aims to provide a framework
for a set of samples that have _differing_ numbers of genomic ranges.
...
The four main functions for row management are: 

* [sparseAssay](#sparseassay)
* [compactAssay](#compactassay)
* [disjoinAssay](#disjoinassay)
* [qreduceAssay](#qreduceassay)
